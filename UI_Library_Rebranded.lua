    ...
    for _, parent in pairs(parents) do
        if parent then
            for _, v in pairs(parent:GetChildren()) do
                if v:IsA("ScreenGui") and v.Name == "XovaGui" or v.Name == "Xovauitoo" then
                    v:Destroy()
                end
            end
        end
...
function Library:Window(Args)
    ...
    local LogoId = Args.Logo or 110769211417501
    local WelcomeTitle = Args.WelcomeTitle or Title
    local Dev1Name = Args.Developer and Args.Developer.Name or "Developer"
    local Dev1Role = Args.Developer and Args.Developer.Role or "Script Developer"
    local Dev1Avatar = Args.Developer and Args.Developer.Avatar or 6443528638
    local Dev2Name = Args.SecondOwner and Args.SecondOwner.Name or "Co-Owner"
    local Dev2Role = Args.SecondOwner and Args.SecondOwner.Role or "UI Developer"
    local Dev2Avatar = Args.SecondOwner and Args.SecondOwner.Avatar or 6443528638
    local THEME = Color3.fromRGB(220, 30, 55)
    local THEME_DIM = Color3.fromRGB(90, 0, 20)
    ...
    local Return_1 = Library:Create("ImageLabel", {
        ...
        ImageColor3 = Color3.fromRGB(220, 30, 55),
        Visible = false
    })
    ...
    local Title_1 = Library:Create("TextLabel", {
        ...
        RichText = true,
        Text = Title,
        TextColor3 = Color3.fromRGB(220, 30, 55),
        TextSize = 14,
        TextStrokeTransparency = 0.699999988079071,
        TextXAlignment = Enum.TextXAlignment.Left
    })
    ...
    local Asset_1 = Library:Create("ImageButton", {
        ...
        Image = "http://www.roblox.com/asset/?id=81116723474925",
        --ImageColor3 = Color3.fromRGB(220, 30, 55),
        LayoutOrder = 1
    })

    Asset_1.MouseButton1Click:Connect(function()
setclipboard("https://discord.gg/27Qc2TmT4v")
end)


    local Asset_2 = Library:Create("ImageButton", {
        Name = "Asset",
        Parent = Expires_1,
        BackgroundColor3 = Color3.fromRGB(255, 255, 255),
        BackgroundTransparency = 1,
        ...
        BorderSizePixel = 0,
        Size = UDim2.new(0, 20, 0, 20),
        Image = "http://www.roblox.com/asset/?id=112944452285971",
        ImageTransparency = 0.5,
        --ImageColor3 = Color3.fromRGB(220, 30, 55),
        LayoutOrder = 1
    })

    Asset_2.MouseButton1Click:Connect(function()
setclipboard("https://discord.gg/27Qc2TmT4v")
end)


local Asset_3 = Library:Create("ImageButton", {
    Name = "Asset",
    Parent = Expires_1,
    BackgroundColor3 = Color3.fromRGB(255, 255, 255),
    BackgroundTransparency = 1,
...
-- CLICK EVENT
Asset_3.MouseButton1Click:Connect(function()
    if Xova and Xova.Destroy then
        Xova:Destroy()
    end
end)
...
local THETIME = Library:Create("TextLabel", {
    ...
    -- ============================================================
    -- WELCOME BANNER (full-width pinned above pages)
    -- ============================================================
    ...
    Library:Create("ImageLabel", {
        ...
        BorderSizePixel = 0,
        Size = UDim2.new(1, 0, 1, 0),
        Image = "rbxassetid://110769211417501",
        ImageColor3 = THEME,
    ...
    Library:Create("TextLabel", {
        ...
        Font = Enum.Font.GothamBold,
        RichText = true,
        Text = "Welcome to " .. WelcomeTitle .. ",  <font color='#FF3050'>" .. PlayerName .. "!</font>",
        TextColor3 = Color3.fromRGB(255, 255, 255),
        TextSize = 13,
        TextXAlignment = Enum.TextXAlignment.Left,
        LayoutOrder = 1,
    ...
    Library:Create("TextLabel", {
        ...
        Text = SubTitle .. " | Join Discord For Updates!",
    ...
    -- ============================================================
    -- OWNER CARDS row (full-width, two side-by-side cards)
    -- ============================================================
    ...
    local function MakeOwnerCard(parent, layoutOrder, avatarId, name, role)
        ...
        local AvatarFrame = Library:Create("ImageLabel", {
            ...
            Image = "https://www.roblox.com/headshot-thumbnail/image?userId=" .. avatarId .. "&width=150&height=150&format=png",
            ImageColor3 = Color3.fromRGB(255, 255, 255),
        })
        Library:Create("UICorner", { Parent = AvatarFrame, CornerRadius = UDim.new(1, 0) })
        --Library:Create("UIStroke", { Parent = AvatarFrame, Color = THEME, Thickness = 1.5 })
    ...
    MakeOwnerCard(OwnersRow, 1, Dev1Avatar, Dev1Name, Dev1Role)
    MakeOwnerCard(OwnersRow, 2, Dev2Avatar, Dev2Name, Dev2Role)
    ...
    function Window:NewPage(Args)
        ...
        Library:Create("UIStroke", {
            Parent = NewTabs,
            Color = Color3.fromRGB(220, 30, 55),
            Thickness = 1
        })
...
function Page:Section(Text)
    ...
    local Dot = Library:Create("Frame", {
        Name = "Dot",
        Parent = Title,
        BackgroundColor3 = Color3.fromRGB(220, 30, 55), -- your theme color
        BorderSizePixel = 0,
    ...
    return Title
        ...
        function Page:Paragraph(Args)
           ...
           local Left = Rows.Vectorize.Left
        ...
        function Page:Button(Args)
            ...
            local Button = Library:Create("Frame", {
                Name = "Button",
                Parent = Right,
                BackgroundColor3 = Color3.fromRGB(220, 30, 55),
                BorderColor3 = Color3.fromRGB(0, 0, 0),
                BorderSizePixel = 0,
        ...
        function Page:Toggle(Args)
            ...
            local function OnChanged(value)
                if value then
                    ...
                    TitleLabel.TextColor3 = Color3.fromRGB(220, 30, 55)
        ...
        function Page:Slider(Args)
            ...
            local pink  = Color3.fromRGB(220, 30, 55)
            ...
            do
                ...
                function Setting:AddList(Name)
                    ...
                    local function OnValue(value)
                        Title_2.TextColor3 = value and Color3.fromRGB(220, 30, 55) or Color3.fromRGB(255, 255, 255)
...
--// ===== NOVA STYLE SUPPORT =====
function Library:MakeWindow(args)
    ...
    function wrapper:AddPage(args)
        currentPage = win:NewPage({
            Title = args.Title,
            Desc = args.Desc or "",
            Icon = args.Icon or 0
        })
    ...
    function wrapper:AddSection(text)
        if not currentPage then
            error("You must add a page first using :AddPage()")
        end
        return currentPage:Section(text)
    end

    function wrapper:AddParagraph(args)
        if not currentPage then
            error("You must add a page first using :AddPage()")
        end
        return currentPage:Paragraph({
            Title = args.Title,
            Desc = args.Desc or "",
            Image = args.Image
        })
    ...
    function wrapper:AddRightLabel(args)
        if not currentPage then
            error("You must add a page first using :AddPage()")
        end
        return currentPage:RightLabel({
            Title = args.Title,
            Desc = args.Desc or "",
            Right = args.Right
        })
    ...
    function wrapper:AddButton(args)
        if not currentPage then
            error("You must add a page first using :AddPage()")
        end
    ...
    function wrapper:AddToggle(args)
        if not currentPage then
            error("You must add a page first using :AddPage()")
        end
        return currentPage:Toggle({
            Title = args.Title,
            Desc = args.Desc or "",
    ...
    function wrapper:AddSlider(args)
        if not currentPage then
            error("You must add a page first using :AddPage()")
        end
        return currentPage:Slider({
            Title = args.Title,
            Min = args.Min,
            Max = args.Max,
    ...
    function wrapper:AddDropdown(args)
        if not currentPage then
            error("You must add a page first using :AddPage()")
        end
        return currentPage:Dropdown({
            Title = args.Title,
            List = args.List,
            Value = args.Value,
            Callback = args.Callback
    ...
    function wrapper:AddInput(args)
        if not currentPage then
            error("You must add a page first using :AddPage()")
        end
        return currentPage:Input({
            Value = args.Value or "",
            Callback = args.Callback
        })
    end

    function wrapper:AddBanner(assetId)
        if not currentPage then
            error("You must add a page first using :AddPage()")
        end
        return currentPage:Banner(assetId)
    end

    function wrapper:SetExpireTime(text)
        self:SetTimeValue(text)
        return wrapper
    end
